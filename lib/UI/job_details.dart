...
class _JobDetailsState extends State<JobDetails>
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                text:
                                                    'MYR ${isActual ? (selectedJob?.actualSolutionDiscountAmount ?? '0.00') : selectedJob?.estimatedSolutionDiscountAmount ?? '0.00'}',
                                              ),
                                            ],
                                          ),
                                        )
                  ...
                  children: [
                    ...
                    rcpCost?.solutionCost != "MYR 0.00"
                        ? _buildChargeItem(
                            "Solution charges",
                            "MYR " +
                                (((rcpCost?.solutionCost?.amountVal ?? 0))
                                        ?.toStringAsFixed(2) ??
                                    "0.00"),
                            false)
                        : new Container(),
                    ...
                    rcpCost?.discountTotalSumVal != "MYR 0.00"
                        ? _buildChargeItem(
                            "Discount",
                            "- MYR " +
                                (rcpCost?.discountTotalSumVal
                                        ?.toStringAsFixed(2) ??
                                    "MYR 0.00"),
                            false)
                        : new Container(),
                    _buildChargeItem(
                        (rcpCost?.isDiscountValid ?? false) &&
                            ...
                            ? "Total"
                            : "Grand Total",
                        'MYR ${((rcpCost?.totalAmount ?? 0) + (rcpCost?.totalAmountSST ?? 0) - (rcpCost?.discountTotalSumVal ?? 0)).toStringAsFixed(2)}',
                        true),
                    (rcpCost?.isDiscountValid ?? false) &&
                            rcpCost?.discountPercentage != "0%"
                        ? _buildChargeItem(
                    ...
                    (rcpCost?.isDiscountValid ?? false) &&
                        ...
                        ? _buildChargeItem(
                            "Grand Total",
                            'MYR ${((rcpCost?.totalAmountRCP ?? 0) + (rcpCost?.totalAmountSSTRCP ?? 0) - (rcpCost?.rcpDiscountTotalSumVal ?? 0)).toStringAsFixed(2)}',
                            true)
                        : new Container(),
                  ],
                ),
                                ...
                                selectedJob?.transportCharge != null
                                    ? RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(
                                              text: selectedJob?.transportCharge
                                                  ?.priceFormatted,
                                            ),
                                          ],
                                        ),
                        ...
                        selectedJob?.pickupCharge != null &&
                            ...
                            ? DropdownButtonFormField<String>(
                                ...
                                value: selectedJob != null
                                    ? selectedJob
                                        ?.pickupCharge?.pickupDescription
                                    : allPickupCharges != null
                                        ? (allPickupCharges ?? [])[0]
                                            .pickupDescription
                                        : "",
  ...
  Future<void> fetchJobHistory() async {
    List<Job>? history = await Repositories.fetchJobHistory(
        selectedJob?.serviceRequestid ?? "",
        selectedJob?.jobInsertedDate ?? "");

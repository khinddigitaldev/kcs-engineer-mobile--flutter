...
//                     if (res) {
//                       if ((selectedJob!.isChargeable ?? false) &&
//                           selectedJob!.sumTotal != 0) {
//                         if (!signatureErr && !errorEmail) {
//                           //if (res) {
//                           if (payNow ||
//                               (mixedPayment &&
//                                   (dropDownOneSelectedText != null &&
//                                       (dropDownOneSelectedText!.toLowerCase() ==
//                                               "bank transfer" ||
//                                           PMLabelCT.text.toLowerCase() ==
//                                               "cash") &&
//                                       dropDownOneSelectedText?.toLowerCase() !=
//                                           "cheque"))) {
...
//     paymentMethods = await Repositories.fetchPaymentMethods();
//   }

//   _fetchPaymentMethodLabels() async {
//     paymentMethodLabels = await Repositories.fetchPaymentMethodLabels();
//   }
